    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-background to-accent/30 p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">myTracker</CardTitle>
          <CardDescription className="text-base">
            Track anything. See your progress. Build better habits.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-center text-xs text-muted-foreground">
            Free to use. No subscriptions. Your data stays yours.
          </p>
        </CardContent>
      </Card>
    </div>
